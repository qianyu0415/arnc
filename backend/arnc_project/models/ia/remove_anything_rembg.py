...
from sam_segment import predict_masks_with_sam, predict_masks_with_sam_box
...
if __name__ == "__main__":
    ...
    img, image = load_img_to_array(args.input_img)
    ...
    bbox_coord = [x_min, y_min , x_max, y_max]

    bbox = np.array(bbox_coord)
